...
('jattmooseala6969+admin@gmail.com', true, 'Admin','Admin', 'password', 1),
('jattmooseala6969+anne@gmail.com', true, 'Anne','Annerson', 'password', 2),
('jattmooseala6969+barb@gmail.com', true, 'Barb','Barber', 'password', 2);

INSERT INTO `note` (`Title`, `Contents`, `Owner`) VALUES
('Quote #1', 'Writing is nature''s way of letting you know how sloppy your thinking is.', 'jattmooseala6969+anne@gmail.com'),
('Another quote', '"Java is to JavaScript as ham is to hamster." -  Jeremy Keith', 'jattmooseala6969+anne@gmail.com'),
('Barb''s Note', 'Anne should not see this note.', 'jattmooseala6969+barb@gmail.com');
